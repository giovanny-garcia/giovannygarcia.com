...
export const projects: Project[] = [
  {
    title: "Tiles Ascend",
    description:
      "A game I built in Godot 4.3 and shipped to the web. It is written in GDScript, exported for the browser, and published on itch.io. You can play that build below.",
